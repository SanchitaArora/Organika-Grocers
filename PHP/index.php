...
<section class="category" id="category">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <p>upto 12% off</p><br><br>
            <img src="57.jpg"  height="155px" width="245px" alt=""><br><br>
...
<section class="product" id="product">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <div class="price"> Rs.55  <span> Rs.62 </span> </div>
            <div class="quantity">
                <span>quantity : </span>
                <input type="number" min="1" max="1000" value="1">
                <span> /L </span>
        ...
        <div class="box">
            ...
            <div class="price"> Rs.250 <span>Rs.275 </span> </div>
            <div class="quantity">
                <span>quantity : </span>
                <input type="number" min="1" max="1000" value="1">
                <span> /500g </span>
        ...
        <div class="box">
            ...
            <div class="price"> Rs.80 <span> Rs.89 </span> </div>
            <div class="quantity">
                <span>quantity : </span>
                <input type="number" min="1" max="1000" value="1">
                <span> /mL </span>
        ...
        <div class="box">
            ...
            <div class="price"> Rs.100.90 <span> Rs.105.69 </span> </div>
            <div class="quantity">
                <span>quantity : </span>
                <input type="number" min="1" max="1000" value="1">
                <span> /500g </span>
   ...
   <div class="box">
            ...
            <div class="price"> Rs.95.90 <span> Rs.110</span> </div>
            <div class="quantity">
                <span>quantity : </span>
                <input type="number" min="1" max="1000" value="1">
                <span> /Packet </span>
